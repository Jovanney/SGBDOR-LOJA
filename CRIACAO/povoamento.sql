...
INSERT INTO Usuario VALUES (usuario_tp('pessoaA@gmail.com','AAAAAA','Pessoa A', 18, (SELECT REF(E) FROM Endereco E WHERE E.CEP = '11111200'), varray_telefone(telefone_tp(9981815244), telefone_tp(9111111111))));
INSERT INTO Usuario VALUES (usuario_tp('pessoaB@gmail.com','BBBBBB','Pessoa B', 19, (SELECT REF(E) FROM Endereco E WHERE E.CEP = '11111200'), varray_telefone(telefone_tp(9981815244), telefone_tp(9222222222))));
